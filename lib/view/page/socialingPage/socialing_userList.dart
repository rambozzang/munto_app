...
class SocialingUserList extends StatefulWidget {
  final String className;
  final int itemId;

  SocialingUserList(this.className, this.itemId);
  @override
  _SocialingUserListState createState() => _SocialingUserListState();
}

class _SocialingUserListState extends State<SocialingUserList>
